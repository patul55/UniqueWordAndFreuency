...
/* Author : Atul Patil
 * Date   : 28-05-2020
 * Purpose : This is code for getting multiple file and process back to its unique word to single Directory with frequency of each word that appear in text file with descending order
 * Version : 1.4  
 */
import java.io.*;
...
public class Word_collection_with_sorting_Frequency_values {
	static void RecursivePrint(File[] arr, int level) throws IOException {
		...
		FileOutputStream outputStream = new FileOutputStream("/home/atul/Hind_Word_addition/out_master/word_dict.txt");
		OutputStreamWriter outputStreamWriter = new OutputStreamWriter(outputStream, "UTF-8");
		BufferedWriter bufferedWriter = new BufferedWriter(outputStreamWriter);

		FileOutputStream outputStream_frequncy = new FileOutputStream(
				"/home/atul/Hind_Word_addition/out_master/word_dict_Frequency.csv");
...
// this method use for sorting map values in descending order 
	...
	public static void main(String[] args) throws IOException {
		...
		String maindirpath = "/home/atul/Hind_Word_addition/master";
